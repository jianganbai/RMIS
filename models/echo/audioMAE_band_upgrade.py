...
class AudioMAEWithBand(nn.Module):
    ...
    def preprocess_batch_audio_to_spectrogram(self, audio_signal, sample_rate=16000):
        """Convert a batch of waveforms [B, T] into normalized spectrograms."""
        import torchaudio

        waveform = audio_signal - audio_signal.mean(dim=-1, keepdim=True)
